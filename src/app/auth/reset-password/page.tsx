...
export default function ResetPasswordPage() {
  ...
  const resetPassword = async () => {
    ...
    try {
      ...
      setTimeout(() => router.push('/auth/login'), 1100);
    } catch (err: any) {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-100 via-white to-green-100 px-4 relative overflow-hidden">
      ...
      >
        ...
        >
          ...
          <h2 className="text-2xl font-bold text-emerald-700 text-center">Set New Password</h2>
          <p className="text-gray-500 text-center text-sm mt-1">Enter a new password for your account</p>
        </motion.div>
        <motion.input
          type="password"
